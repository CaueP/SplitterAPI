...
CALL pr_associar_cliente_mesa ('ana_maria@gmail.com', 1, '001BARDOFRANana_maria@gmail.com', 'BARDOFRAN', 1);
...
CALL pr_realizar_pedido('BARDOFRAN', 1, 3, 2, 'Bem passado', 1); -- ana - FRAN
...
CALL pr_atualizar_status_mesa(1, 'BARDOFRAN', '001BARDOFRAN', 0);
