...
INSERT INTO tb_tp_alimento VALUES(2, 'Por��es');
...
VALUES ('Batata Frita', 2, 'Batata frita, por��o de 500 gramas', 22.50, 'http://www.restaurantecozinhaitaliana.com.br/files/batata.jpg', 1);
INSERT INTO tb_produto (nome_produto, cod_tp_alimento, dsc_produto, val_produto, link_img_produto, cod_estabelecimento)
VALUES('Batata Frita Suprema', 2, 'Batata frita com cheddar, bacon e queijo ralado, por��o de 500 gramas', 27.50, 'http://www.bigxpicanha.com.br/Content/Produto/Imagem/Fritas-com-Cheddar-e-Bacon-108.png', 1);
INSERT INTO tb_produto (nome_produto, cod_tp_alimento, dsc_produto, val_produto, link_img_produto, cod_estabelecimento)
VALUES ('Mini Coxinha', 2, 'Coxinhas de Frango, por��o de 10 unidades', 32.00, 'http://natashopping.com.br/lojas/supermercadonata/produtos/15688/galeria/mini-coxinha-com-catupiry-cento-400x400-1.jpg', 1);
INSERT INTO tb_produto (nome_produto, cod_tp_alimento, dsc_produto, val_produto, link_img_produto, cod_estabelecimento)
VALUES ('Azeitonas', 2, 'Azeitonas (Verde ou Preta), por��o de 100 gramas', 15.00, 'http://garotasfdp.com.br/wp-content/uploads/2017/02/azeitona.jpg', 1);
INSERT INTO tb_produto (nome_produto, cod_tp_alimento, dsc_produto, val_produto, link_img_produto, cod_estabelecimento)
VALUES ('Sucos', 8, 'Sucos Naturais de Uva, Manga, Goiaba, P�ssego, Maracuj�', 9.00, 'http://www.seucorpoperfeito.com.br/wp-content/uploads/2015/01/sucos-funcionais-anti-acne.jpg', 1);
INSERT INTO tb_produto (nome_produto, cod_tp_alimento, dsc_produto, val_produto, link_img_produto, cod_estabelecimento)
VALUES ('�gua', 8, '�gua (Natural ou Com g�s)', 4.00, 'http://cdn.ecycle.com.br/images/eDicas/diaadia/garrafa-pet-agua.jpg', 1);
INSERT INTO tb_produto (nome_produto, cod_tp_alimento, dsc_produto, val_produto, link_img_produto, cod_estabelecimento)
VALUES ('Pizza Calabresa', 6, 'Pizza 8 fatias. Ingredientes: Molho, mussarela, calabresa, cebola fatiada e or�gano.', 32.00, 'http://biancapizzaria.com.br/wp-content/uploads/2015/07/03-calabresa3-600x500.png', 1);
INSERT INTO tb_produto (nome_produto, cod_tp_alimento, dsc_produto, val_produto, link_img_produto, cod_estabelecimento)
VALUES ('Pizza Mussarela', 6, 'Pizza 8 fatias. Molho, mussarela, tomate em rodelas e or�gano.', 28.00, 'http://biancapizzaria.com.br/wp-content/uploads/2015/07/01-mussarela7-600x500.png', 1);
INSERT INTO tb_produto (nome_produto, cod_tp_alimento, dsc_produto, val_produto, link_img_produto, cod_estabelecimento)
VALUES ('Pizza Margherita', 6, 'Pizza 8 fatias. Ingredientes: Molho, mussarela, calabresa, cebola fatiada e or�gano.', 38.00, 'http://biancapizzaria.com.br/wp-content/uploads/2015/07/24-margherita3-600x500.png', 1);

INSERT INTO tb_produto (nome_produto, cod_tp_alimento, dsc_produto, val_produto, link_img_produto, cod_estabelecimento)
VALUES('Batata Frita', 2, 'Batata frita, por��o de 500 gramas', 22.50, 'http://www.restaurantecozinhaitaliana.com.br/files/batata.jpg', 2);
INSERT INTO tb_produto (nome_produto, cod_tp_alimento, dsc_produto, val_produto, link_img_produto, cod_estabelecimento)
VALUES ('Batata Frita Suprema', 2, 'Batata frita com cheddar, bacon e queijo ralado, por��o de 500 gramas', 27.50, 'http://www.bigxpicanha.com.br/Content/Produto/Imagem/Fritas-com-Cheddar-e-Bacon-108.png', 2);
INSERT INTO tb_produto (nome_produto, cod_tp_alimento, dsc_produto, val_produto, link_img_produto, cod_estabelecimento)
VALUES ('Mini Coxinha', 2, 'Coxinhas de Frango, por��o de 10 unidades', 32.00, 'http://natashopping.com.br/lojas/supermercadonata/produtos/15688/galeria/mini-coxinha-com-catupiry-cento-400x400-1.jpg', 2);
INSERT INTO tb_produto (nome_produto, cod_tp_alimento, dsc_produto, val_produto, link_img_produto, cod_estabelecimento)
VALUES('Azeitonas', 2, 'Azeitonas (Verde ou Preta), por��o de 100 gramas', 15.00, 'http://garotasfdp.com.br/wp-content/uploads/2017/02/azeitona.jpg', 2);
INSERT INTO tb_produto (nome_produto, cod_tp_alimento, dsc_produto, val_produto, link_img_produto, cod_estabelecimento)
VALUES ('Sucos', 8, 'Sucos Naturais de Uva, Manga, Goiaba, P�ssego, Maracuj�', 9.00, 'http://www.seucorpoperfeito.com.br/wp-content/uploads/2015/01/sucos-funcionais-anti-acne.jpg', 2);
INSERT INTO tb_produto (nome_produto, cod_tp_alimento, dsc_produto, val_produto, link_img_produto, cod_estabelecimento)
VALUES ('�gua', 8, '�gua (Natural ou Com g�s)', 4.00, 'http://cdn.ecycle.com.br/images/eDicas/diaadia/garrafa-pet-agua.jpg', 2);
INSERT INTO tb_produto (nome_produto, cod_tp_alimento, dsc_produto, val_produto, link_img_produto, cod_estabelecimento)
VALUES ('Comercial', 6, 'Bife, frango ou Calabresa com arroz, feij�o, fritas e ovo', 15.00, 'http://grinvillefastfood.com.br/img/gallery/pratos/full/image22.jpg', 2);
INSERT INTO tb_produto (nome_produto, cod_tp_alimento, dsc_produto, val_produto, link_img_produto, cod_estabelecimento)
VALUES ('Contra-Filet', 6, 'Contra-Filet com arroz e fritas', 18.00, 'http://www.mouriscoforneria.com.br/images/picanha-prato.jpg', 2);
INSERT INTO tb_produto (nome_produto, cod_tp_alimento, dsc_produto, val_produto, link_img_produto, cod_estabelecimento)
VALUES ('Filet � Parmegiana', 6, 'Parmegiana com arroz e fritas', 20.00, 'https://i2.wp.com/bardohelio.com.br/wp-content/uploads/2015/08/contra-file-parmegiana.jpg?fit=988%2C659', 2);
