...
VALUES (1, 0, 1, '001BARFRAN', '001BARFRAN', 0, null, 0);

INSERT INTO tb_mesa (cod_mesa, ind_status_mesa, cod_estabelecimento, cod_qr, cod_qr_ocupado, tp_divisao, id, qtd_pessoas)
VALUES (1, 0, 2, '002BARFRAN', '002BARFRAN', 0, null, 0);

-- IMPBEBIDAS
INSERT INTO tb_mesa (cod_mesa, ind_status_mesa, cod_estabelecimento, cod_qr, cod_qr_ocupado, tp_divisao, id, qtd_pessoas)
VALUES (2, 0, 1, '001IMPBEBIDAS', '001IMPBEBIDAS', 0, null, 0);

-- BARBRAHMA
INSERT INTO tb_mesa (cod_mesa, ind_status_mesa, cod_estabelecimento, cod_qr, cod_qr_ocupado, tp_divisao, id, qtd_pessoas)
VALUES (1, 0, 3, '001BARBRAHMA', '', 0, null, 0);
